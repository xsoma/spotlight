...
void Movement::Strafe() {
	...
	// do allign strafer.
	if ( c_keyhandler::get( )->auto_check( "astrafe_key" ) ) {
...
void Movement::AutoPeek() {
	if ( ( c_config::get( )->b[ "quickstop" ] ) && g_aimbot.m_stop ) {
		Movement::QuickStop( );
	}
}
