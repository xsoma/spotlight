...
namespace ui
{
    ...
    IMGUI_API  void CustomSpacing(float h);
...
struct ImDrawList
{
    ...
    IMGUI_API void AddCircularProgressBar(const ImVec2& center, float radius, ImU32 col, float progress, int num_segments, float thickness);
