...
void Skins::think( ) {
	...
	for ( int i{ 1 }; i <= g_csgo.m_entlist->GetHighestEntityIndex( ); ++i ) {
		...
		// run knifechanger.
		if ( c_config::get( )->i[ "knife" ] > 0 && ent->is( HASH( "CPredictedViewModel" ) ) ) {
			...
			if ( weapon->IsKnife( ) ) {
				...
				else if ( c_config::get( )->i[ "knife" ] == 0 ) {
					// fix definition.
			...
			case DEAGLE:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_deagle" ];
				...
				break;
			case ELITE:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_elite" ];
				...
				break;
			case FIVESEVEN:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_fiveseven" ];
				...
				break;
			case GLOCK:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_glock" ];
				...
				break;
			case AK47:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_ak47" ];
				...
				break;
			case AUG:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_aug" ];
				...
				break;
			case AWP:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_awp" ];
				...
				break;
			case FAMAS:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_famas" ];
				...
				break;
			case G3SG1:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_g3sg1" ];
			...
			case GALIL:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_galil" ];
				...
				break;
			case M249:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_m249" ];
				...
				break;
			case M4A4:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_m4a4" ];
				...
				break;
			case MAC10:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_mac10" ];
				...
				break;
			case P90:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_p90" ];
				...
				break;
			case UMP45:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_ump45" ];
				...
				break;
			case XM1014:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_xm1014" ];
				...
				break;
			case BIZON:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_bizon" ];
				...
				break;
			case MAG7:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_mag7" ];
				...
				break;
			case NEGEV:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_negev" ];
				...
				break;
			case SAWEDOFF:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_sawedoff" ];
				...
				break;
			case TEC9:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_tec9" ];
				...
				break;
			case P2000:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_p2000" ];
				...
				break;
			case MP7:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_mp7" ];
				...
				break;
			case MP9:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_mp9" ];
				...
				break;
			case NOVA:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_nova" ];
				...
				break;
			case P250:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_p250" ];
				...
				break;
			case SCAR20:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_scar20" ];
				...
				break;
			case SG553:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_sg553" ];
				...
				break;
			case SSG08:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_ssg08" ];
				...
				break;
			case M4A1S:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_m4a1s" ];
				...
				break;
			case USPS:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_usps" ];
				...
				break;
			case CZ75A:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_cz75a" ];
				...
				break;
			case REVOLVER:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_revolver" ];
				...
				break;
			case KNIFE_BAYONET:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_bayonet" ];
				...
				break;
			case KNIFE_FLIP:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_flip" ];
				...
				break;
			case KNIFE_GUT:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_gut" ];
				...
				break;
			case KNIFE_KARAMBIT:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_karambit" ];
			...
			case KNIFE_M9_BAYONET:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_m9" ];
				...
				break;
			case KNIFE_HUNTSMAN:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_huntsman" ];
				...
				break;
			case KNIFE_FALCHION:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_falchion" ];
				...
				break;
			case KNIFE_BOWIE:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_bowie" ];
			...
			case KNIFE_BUTTERFLY:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_butterfly" ];
			...
			case KNIFE_SHADOW_DAGGERS:
				weapon->m_nFallbackPaintKit( ) = c_config::get( )->i[ "id_daggers" ];
	...
	if ( c_config::get( )->i[ "glove" ] > 0 ) {
		...
		// set custom data.
		glove->m_nFallbackPaintKit( ) = 10000 + c_config::get( )->i[ "glove_id" ];
